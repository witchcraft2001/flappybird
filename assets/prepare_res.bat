...
python ..\..\tools\resources.py ..\title_res.txt
...
copy big_digit0.bin /B + big_digit1.bin /B + big_digit2.bin /B + big_digit3.bin /B + big_digit4.bin /B + big_digit5.bin /B + big_digit6.bin /B + big_digit7.bin /B + big_digit8.bin /B + big_digit9.bin /B + small_digit0.bin /B + small_digit1.bin /B + small_digit2.bin /B + small_digit3.bin /B + small_digit4.bin /B + small_digit5.bin /B + small_digit6.bin /B + small_digit7.bin /B + small_digit8.bin /B + small_digit9.bin /B + coin0.bin /B + coin1.bin /B + coin2.bin /B + coin3.bin /B + medal_placeholder.bin /B + ui_hand.bin /B + title_get_ready.bin /B + title_game_over.bin /B + title_flappybird.bin /B ui.bin /B
python ..\..\tools\wav2sfx.py --out-dir . --asm sfx_len.asm ..\sfx\wav\hit.wav ..\sfx\wav\die.wav ..\sfx\wav\point.wav
cd ..
pause 0

...
GAME_ASSETS := city.bin way.bin birds.bin tubes.bin ui.bin gopanel.bin font.bin title.bin title.b00 title.b01 title.b02 title.b03 title.b04 music.bin
...
clean:
	rm -rf $(BUILD_DIR) $(ASSETS_DIR)/cutted $(ASSETS_DIR)/resources $(SRC_DIR)/assets $(SRC_DIR)/res_pal.asm $(SRC_DIR)/title_pal.asm $(SRC_DIR)/FBIRD.EXE $(SRC_DIR)/fbird.lst
